...
| `tier_f_commands.py` | Tier F — ConPTY injection for interactive-only commands (goal/planning/fast/etc). |
...
The MCP server exposes **39 tools** that let external clients drive agy's internal
